  ...
  return (
    <div className="tool-card" style={{ maxWidth: '800px', margin: '20px auto', padding: '30px', color: 'var(--text)' }}>
      ...
      <p style={{ lineHeight: '1.6', marginBottom: '20px' }}>
        Welcome to <strong>OminConvert</strong>! By accessing our website at <a href="https://ominconvert.com" style={{ color: 'var(--primary)' }}>https://ominconvert.com</a>, you agree to comply with and be bound by the following terms and conditions of use.
      </p>

      <h3 style={{ fontSize: '1.2rem', marginTop: '25px', marginBottom: '10px' }}>1. Acceptance of Terms</h3>
      <p style={{ lineHeight: '1.6', marginBottom: '20px' }}>
        By visiting or using any of the tools provided on OminConvert, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you must not use our website or services.
      </p>

      <h3 style={{ fontSize: '1.2rem', marginTop: '25px', marginBottom: '10px' }}>2. Use License and Permitted Use</h3>
      <p style={{ lineHeight: '1.6', marginBottom: '20px' }}>
        OminConvert grants you a free, non-exclusive, non-transferable license to use our web-based tools (Image-to-Text OCR, Image Converter, Social Media Resizer, and Document Converter) for personal or commercial purposes. 
      ...
      <p style={{ lineHeight: '1.6', marginBottom: '20px' }}>
        OminConvert is provided "as is" and "as available". We make no warranties, expressed or implied, regarding the accuracy, completeness, performance, or availability of the tools. Because all file processing happens directly in your browser using client-side engines, results may vary depending on file size, format compatibility, and device performance. 
      </p>

      <h3 style={{ fontSize: '1.2rem', marginTop: '25px', marginBottom: '10px' }}>5. Limitation of Liability</h3>
      <p style={{ lineHeight: '1.6', marginBottom: '20px' }}>
        In no event shall OminConvert, its owners, or affiliates be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the tools on OminConvert, even if notified orally or in writing of the possibility of such damage.
      </p>

      <h3 style={{ fontSize: '1.2rem', marginTop: '25px', marginBottom: '10px' }}>6. Revisions and Errata</h3>
      <p style={{ lineHeight: '1.6', marginBottom: '20px' }}>
        The materials appearing on OminConvert could include technical, typographical, or photographic errors. We do not promise that any of the materials on this website are accurate, complete, or current. OminConvert may make changes to the materials contained on its website at any time without notice.
      </p>

      <h3 style={{ fontSize: '1.2rem', marginTop: '25px', marginBottom: '10px' }}>7. Governing Law</h3>
      <p style={{ lineHeight: '1.6', marginBottom: '20px' }}>
        Any claim relating to OminConvert shall be governed by the laws of our operating jurisdiction, without regard to its conflict of law provisions.
      </p>
